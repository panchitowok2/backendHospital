...
describe('Camino 8: Alta tratamiento farmacologico', () => {
  //antes de cada test
  beforeEach(async () => {
  ...
  // camino 8
  it('Camino 8: No existen medicamentos', async () => {
    ...
    expect(medicamentos.status).toEqual(404);
