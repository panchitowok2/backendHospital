...
describe('Camino 5: buscar consultas por enfermedad', () => {
  //antes de cada test
  beforeEach(async () => {
  ...
  it('Camino 5: existen enfermedades,existen consultas en esas fechas,existen diagnosticos para esa enfermedad,existen consultas con esa enfermedad y en esas fechas', async () => {
 ...
 .send({"fechaInicio":"1960/01/01","fechaFin":"2023/04/24"})
 ...
 .send({"id_enfermedad":"651c8165c2688411e6edc9e5", "fecha_inicio":"1960/01/01","fecha_fin":"2023/04/24"})
 expect(consultas_por_enfermedad.status).toEqual(200);
