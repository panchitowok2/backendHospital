...
describe('Camino 7: Alta consulta', () => {
  //antes de cada test
  beforeEach(async () => {
  ...
  it('Camino 7: La persona existe, tiene historia clínica, existen médicos, existen turnos,existen enfermedades, no se pudo dar de alta (falla el diagnostico por la enfermdad)', async () => {
   ...
   .get('/api/obtener_enfermedades')
    ...
    .send({
      ...
      "id_turno":"651c81a20e98da958eccf76a",
      ...
      "id_enfermedad":"651c8181aebb86e72f4224e1",
      "id_historia_clinica":"651c818d683aa5bd5aa29156"
      });
      expect(alta_consulta_y_diagnostico.status).toEqual(404)
      expect(alta_consulta_y_diagnostico.body).toHaveProperty('error', true);
  });
