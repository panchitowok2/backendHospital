...
describe('Camino 6: Alta consulta', () => {
  //antes de cada test
  beforeEach(async () => {
  ...
  it('Camino 6: La persona existe, tiene historia clínica, existen médicos, existen turnos,existen enfermedades, no se pudo dar de alta (falla la consulta por el turno)', async () => {
