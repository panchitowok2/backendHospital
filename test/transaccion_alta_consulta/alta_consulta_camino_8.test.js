...
describe('Camino 8: Alta consulta', () => {
  //antes de cada test
  beforeEach(async () => {
  ...
  it('Camino 8: La persona existe, tiene historia clínica, existen médicos, existen turnos,existen enfermedades, no se pudo dar de alta (falla por la id historia clinica)', async () => {
   ...
   .get('/api/obtener_enfermedades')
    ...
    .send({
      ...
      "id_historia_clinica":"651c8181aebb86e72f4224e1"
      });
