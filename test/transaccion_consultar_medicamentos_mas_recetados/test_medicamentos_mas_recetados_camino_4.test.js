...
describe('Camino 4: Consultar medicamentos mas recetados', () => {
  //antes de cada test
  beforeEach(async () => {
  ...
  //camino 4
  it('Camino 4: Error al consultar los medicamentos más recetados', async () => {
    ...
    var dataParams = {
      ...
      //"fecha_inicio": "1950-01-01",   comentado para forzar el test
    ...
    expect(medicamentosMasRecetados.status).toEqual(400);
